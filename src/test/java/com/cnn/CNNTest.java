...
//                // Windows
    ...
    private WebDriver createDriver(String environment, String browser, String version, String os, String device, String methodName) throws MalformedURLException {
        ...
        sauceVisual.setCapability("projectName", "CNN-project");
...
//Creates Visual Driver
    ...
    public void CNNPageTitle(String type, String browser, String version, String os, String device, Method method) throws Exception {
        ...
        js.executeScript("/*@visual.snapshot*/", "CNN Home Page");
...
//        Assert.assertTrue((Boolean)response.get("passed"), (String)response.get("message"));
    ...
    @Test(dataProvider = "hardCodedBrowsers")
    public void CNNSports(String type, String browser, String version, String os, String device, Method method) throws Exception {
        this.createDriver(type, browser, version, os, device, method.getName());
        WebDriver driver = this.getWebDriver();
        driver.get("https://cnn.com");
...
//        js.executeScript("/*@visual.init*/", "CNN Visual Test");
        ...
        js.executeScript("/*@visual.snapshot*/", "CNN Sports Page");

        this.annotate("sleeping for a few seconds so humans can see the changes");
        js.executeScript("/*@visual.snapshot*/", "CNN Sports");
        Map response = (Map)((JavascriptExecutor) driver).executeScript("/*@visual.end*/");
        Assert.assertTrue((Boolean)response.get("passed"), (String)response.get("message"));
